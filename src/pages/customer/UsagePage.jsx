      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-3">
          <select
            ...
            className="rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-xs font-semibold text-slate-700 outline-none shadow-sm focus:border-[#081936]"
          >
            {RANGES.map((r) => (
        ...
        <>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            <div className="rounded-2xl border border-slate-100 bg-white p-5 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)]">
              ...
              <UsageAreaChart data={filtered} dataKey="dataUsage" color="#081936" label="Data" />
            </div>
            <div className="rounded-2xl border border-slate-100 bg-white p-5 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)]">
...
function UsageDetailCard({ icon: Icon, title, color, rows }) {
  const colors = {
    indigo: "bg-slate-100 text-[#081936]",
